// Optional multi-provider database entry retained for future non-Worker deployments.
// Cloudflare production imports ./index.ts, which is intentionally PostgreSQL-only.
